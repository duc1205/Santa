...
@injectable
class CharityDeliveryFailedPageViewModel extends AppViewModel {
  ...
  CharityDeliveryFailedPageViewModel(
  ...
  Future<bool> sendEmail() async {
    ...
    if (success) {
      final Uri url = Uri(
        ...
        query: "subject= ${LocaleKeys.charity_title_mail_delivery_fail.trans()}&body=${LocaleKeys.charity_body_mail_delivery_fail.trans(
          namedArgs: {
