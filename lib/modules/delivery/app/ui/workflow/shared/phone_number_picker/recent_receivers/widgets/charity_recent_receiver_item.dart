...
class CharityRecentReceiverItem extends StatelessWidget {
  const CharityRecentReceiverItem({Key? key, required this.user, required this.selected, required this.onItemClick}) : super(key: key);
