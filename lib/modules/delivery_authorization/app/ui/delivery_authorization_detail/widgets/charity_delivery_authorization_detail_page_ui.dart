...
class CharityDeliveryAuthorizationDetailPageUI extends StatelessWidget {
  final DeliveryAuthorizationDetailPageViewModel viewModel;

  const CharityDeliveryAuthorizationDetailPageUI({Key? key, required this.viewModel}) : super(key: key);
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "${viewModel.user?.phoneNumber ?? " "} ${viewModel.authorizationName}",
                            style: AppTheme.blackDark_14w400,
                            softWrap: true,
                          ),
                        ],
