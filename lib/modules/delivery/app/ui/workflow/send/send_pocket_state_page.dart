...
import 'package:santapocket/modules/delivery/app/ui/workflow/send/send_pocket_state_page_viewmodel.dart';
...
class SendPocketStatePage extends StatefulWidget {
  const SendPocketStatePage({
  ...
  @override
  State<SendPocketStatePage> createState() => _SendPocketStatePageState();
}

class _SendPocketStatePageState extends BaseViewState<SendPocketStatePage, SendPocketStatePageViewModel> with WidgetsBindingObserver {
  @override
  SendPocketStatePageViewModel createViewModel() => locator<SendPocketStatePageViewModel>();
