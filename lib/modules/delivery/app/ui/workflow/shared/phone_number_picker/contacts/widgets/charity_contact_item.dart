...
class CharityContactItem extends StatelessWidget {
  const CharityContactItem({Key? key, required this.person, required this.isSelected, required this.itemClick}) : super(key: key);
