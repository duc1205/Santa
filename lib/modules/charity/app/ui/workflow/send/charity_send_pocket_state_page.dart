...
import 'package:santapocket/modules/charity/app/ui/workflow/send/charity_send_pocket_state_page_viewmodel.dart';
...
class CharitySendPocketStatePage extends StatefulWidget {
  const CharitySendPocketStatePage({
  ...
  @override
  State<CharitySendPocketStatePage> createState() => _CharitySendPocketStatePageState();
}

class _CharitySendPocketStatePageState extends BaseViewState<CharitySendPocketStatePage, CharitySendPocketStatePageViewModel>
    with WidgetsBindingObserver {
  @override
  CharitySendPocketStatePageViewModel createViewModel() => locator<CharitySendPocketStatePageViewModel>();
  ...
  void loadArguments() {
    ...
    viewModel.gratefulMessage = widget.gratefulMessage;
    super.loadArguments();
  }
