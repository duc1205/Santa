...
import 'package:santapocket/modules/delivery/app/ui/workflow/result/fail/delivery_failed_page_view_model.dart';
import 'package:santapocket/modules/delivery/app/ui/workflow/shared/fill_info/delivery_steps_widget.dart';
import 'package:santapocket/shared/theme/app_theme.dart';
import 'package:suga_core/suga_core.dart';

class DeliveryFailedPage extends StatefulWidget {
  const DeliveryFailedPage({
    Key? key,
    this.deliveryId,
    required this.cabinetInfo,
    this.isFromReceiveDelivery,
  }) : super(key: key);

  final int? deliveryId;
  final CabinetInfo cabinetInfo;
  final bool? isFromReceiveDelivery;

  @override
  State<DeliveryFailedPage> createState() => _DeliveryFailedPageState();
}

class _DeliveryFailedPageState extends BaseViewState<DeliveryFailedPage, DeliveryFailedPageViewModel> {
  @override
  DeliveryFailedPageViewModel createViewModel() => locator<DeliveryFailedPageViewModel>();
    ...
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: Column(
            children: [
              widget.isFromReceiveDelivery != null
                  ? DeliveryStepsWidget(
                      step: 3,
                      isReceiving: widget.isFromReceiveDelivery!,
              ...
              Padding(
                ...
                child: Text(
                  LocaleKeys.delivery_delivery_wrong.trans(),
                  ...
                  child: Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Center(
                          child: Text(
                            LocaleKeys.delivery_reopen_pocket.trans(),
