...
class PaymentSuccess extends StatelessWidget {
  const PaymentSuccess({required this.amount, required this.paymentMethod, Key? key, this.paymentOrder}) : super(key: key);
  final int amount;
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            LocaleKeys.payment_payment_successful.trans(),
                            style: AppTheme.green_14w600,
                          ),
                          SizedBox(
                            height: 8.h,
                          ),
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Visibility(
                                      visible: paymentOrder?.productData != null,
                                      child: Text(
                                        FormatHelper.formatCurrencyV2(FormatHelper.roundSantaXu(paymentOrder?.productData?.price ?? 0)),
                                        style: AppTheme.black_14w400,
                                      ),
                                    ),
                                  ],
                                          ...
                                          Visibility(
                                            ...
                                            child: Text(
                                              FormatHelper.formatCurrencyV2(
                                                FormatHelper.roundSantaXu(
                                                  (paymentOrder?.productData?.value ?? 0) - (paymentOrder?.productData?.price ?? 0),
                                                ),
                                              ),
                                              style: AppTheme.black_14w400,
                                            ),
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Assets.icons.icPaymentSuccess.image(
                        height: 58.h,
                        width: 65.w,
                      ),
                    ),
