...
class DeliveryDetailPageUI extends StatelessWidget {
  final int deliveryId;
  final DeliveryDetailPageViewModel viewModel;

  const DeliveryDetailPageUI({Key? key, required this.deliveryId, required this.viewModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: Text(
          "${LocaleKeys.delivery_delivery_id.trans()} ${FormatHelper.formatId(viewModel.deliveryId)}",
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Obx(
                        () => viewModel.checkHadAuthorize() && viewModel.isReceiver
                            ? Padding(
                            ...
                            ? TextButton(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: AppTheme.white, boxShadow: [
                                    BoxShadow(color: AppTheme.black.withOpacity(0.3), offset: const Offset(0, 0), spreadRadius: 0.3, blurRadius: 0.3),
                                  ]),
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        LocaleKeys.delivery_cancel_authorization.trans(),
                    ...
                    ? viewModel.isReceiver
                              ...
                              child: Row(children: [
                                Expanded(
                                  child: TextButton(
                                    ...
                                    child: Text(
                                      LocaleKeys.delivery_authorize.trans(),
                                ...
                                Expanded(
                                  child: TextButton(
                                    ...
                                    child: Text(LocaleKeys.delivery_receive.trans(), style: AppTheme.blackDark_16w600),
                                  ),
                                ),
                              ]),
                            ),
                        ...
                        : Container(
                            ...
                            child: TextButton(
                              ...
                              child: Text(
                                "${viewModel.countDown > 0 ? LocaleKeys.delivery_cancel.trans() : LocaleKeys.delivery_canceling_was_expired.trans()} (${viewModel.countDownString()})",
    ...
    return viewModel.isReceiver && viewModel.delivery?.status == DeliveryStatus.sent
        ? Container(
            ...
            child: Row(
              children: [
                Text(
                  LocaleKeys.delivery_estimated_fee.trans(),
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                Text(
                  LocaleKeys.delivery_delivery.trans(),
                  style: AppTheme.blackDark_16w700,
                ),
                const Spacer(),
                GestureDetector(
                  ...
                  child: Text(
                    LocaleKeys.delivery_view_detail.trans(),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "${LocaleKeys.delivery_pocket.trans()} ${viewModel.delivery?.extra?.pocketExtra?.localId ?? ""}",
                  style: AppTheme.blackDark_14w700,
                ),
                SizedBox(
                  height: 8.h,
                ...
                Text(
                  "${LocaleKeys.delivery_size.trans()}: ${viewModel.delivery?.pocket?.size?.name ?? ""}",
                  style: AppTheme.blackDarkOp50Percent_14w400,
                ),
              ],
            ),
  ...
  Container _cabinetInfo(PackageCategory? categoryType) {
    ...
    Widget getIconText() {
      switch (categoryType) {
        case PackageCategory.food:
          return Text(
            LocaleKeys.delivery_food.trans(),
            style: AppTheme.blackDark_14w600,
          );
        case PackageCategory.others:
          return Text(
            LocaleKeys.delivery_others.trans(),
            style: AppTheme.blackDark_14w600,
          );
        default:
          return Text(
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                Text(
                  LocaleKeys.delivery_info.trans(),
                  style: AppTheme.blackDark_16w700,
                ),
                const Spacer(),
                getIcon(),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            LocaleKeys.delivery_receiver.trans(),
                            style: AppTheme.blackDark_14w700,
                          ),
                          SizedBox(
                            height: 10.h,
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text(
                        LocaleKeys.delivery_service_fee.trans(),
                        style: AppTheme.blackDark_16w700,
                      ),
                    ],
                  ),
                  ...
                  child: Column(
                    children: [
                      Row(
                        children: [
                          Text(
                            LocaleKeys.delivery_receiving_fee.trans(),
                      ...
                      if ((viewModel.delivery?.chargedAmount ?? 0) > 0)
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text(
                                LocaleKeys.delivery_charging_fee.trans(),
                                style: AppTheme.blackDarkOp50Percent_14w400,
                              ),
                              const Spacer(),
                              Text(
                      ...
                      if ((viewModel.delivery?.refundedAmount ?? 0) > 0)
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text(
                                LocaleKeys.delivery_refunded_amount.trans(),
                                style: AppTheme.blackDarkOp50Percent_14w400,
                              ),
                              const Spacer(),
                              Text(
                      ...
                      Row(
                        children: [
                          Text(
                            LocaleKeys.delivery_total.trans(),
                      ...
                      if ((viewModel.delivery?.coinAmount ?? 0) > 0)
                        Row(
                          children: [
                            Text(
                              LocaleKeys.delivery_santa_coins.trans(),
                              style: AppTheme.blackDarkOp50Percent_14w400,
                            ),
                            const Spacer(),
                            Text(
                              FormatHelper.formatCurrency(FormatHelper.roundSantaXu(viewModel.delivery?.coinAmount ?? 0), unit: ""),
    ...
    return viewModel.statusLogs.isNotEmpty
        ? Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 15.w, vertical: 8.h),
                child: Text(LocaleKeys.delivery_status.trans(), style: AppTheme.blackDark_16w700),
              ),
