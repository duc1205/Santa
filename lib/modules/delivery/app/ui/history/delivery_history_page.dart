...
import 'package:santapocket/modules/delivery/app/ui/history/delivery_history_page_viewmodel.dart';
import 'package:santapocket/modules/delivery/app/ui/history/filter/filter_page.dart';
import 'package:santapocket/modules/delivery/app/ui/history/widgets/delivery_history_list_view.dart';
import 'package:santapocket/modules/delivery/app/ui/history/widgets/empty_deliveries_page.dart';
...
class _DeliveryHistoryPageState extends BaseViewState<DeliveryHistoryPage, DeliveryHistoryPageViewModel> with AutomaticKeepAliveClientMixin {
  @override
  DeliveryHistoryPageViewModel createViewModel() => locator<DeliveryHistoryPageViewModel>();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          LocaleKeys.delivery_delivery_history.trans().toUpperCase(),
                  ...
                  () => Expanded(
                    child: DebounceTextfield(
                      ...
                      inputDecoration: InputDecoration(
                        hintText: LocaleKeys.delivery_search_delivery.trans(),
              ...
              child: Obx(
                () => viewModel.deliveries.isNotEmpty
                    ...
                    : SingleChildScrollView(
                        ...
                        child: viewModel.searchTextController.text.isNotEmpty ? const CabinetNotFoundWidget() : const EmptyDeliveriesPage(),
                      ),
              ),
            ),
          ),
  ...
  List<Widget> _buildFilterTab(int selectedTab, Function(int index) onTap) {
    return List.generate(3, (index) {
      String label = LocaleKeys.delivery_all.trans();
      switch (index) {
        case 0:
          label = LocaleKeys.delivery_all.trans();
          break;
        case 1:
          label = LocaleKeys.delivery_processing.trans();
          break;
        case 2:
          label = LocaleKeys.delivery_finished.trans();
          break;
      }
      return Expanded(
        child: InkWell(
