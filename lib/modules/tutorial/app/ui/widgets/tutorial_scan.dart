...
TargetFocus tutorialScan({required VoidCallback onNext, required VoidCallback onSkip}) {
  return TargetFocus(
    identify: "tutorialScan",
    keyTarget: TutorialGlobalKey.tutorialScan,
    paddingFocus: 10,
          ...
          return Column(
            ...
            children: [
              ...
              Container(
                ...
                width: 290.w,
                child: Text(
                  LocaleKeys.tutorial_tutorial_scan.trans(),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage(Assets.icons.icTutorialArrowScan.path),
                    fit: BoxFit.contain,
                  ),
